...
public class FreeRoomsFrame extends AbstractFrame {
	...
	public FreeRoomsFrame(VerwaltungMainFrame mf,
			...
			public void actionPerformed(ActionEvent e) {
				if (list.getSelectedValuesList().isEmpty()) {
					JOptionPane.showMessageDialog(null,
							"Wählen Sie mindestens ein freies Zimmer");
				} else {
					Room[] tmp = list.getSelectedValuesList().toArray(
							new Room[0]);
					SelectCostumerByRoomFrame scf = new SelectCostumerByRoomFrame(
							mf, frf, tmp, sf);
					scf.init();
